...
$search_column_string = preg_match('/1\.(5\.[6-9]|[6-9]\.[0-9])/', Grocery_CRUD::VERSION) ? $this->l('list_search_column') : 'Buscar {column_name}';

$hasAlerti18n = preg_match('/1\.(5\.[8-9]|[6-9]\.[0-9])/', Grocery_CRUD::VERSION);

$alert_multiple_delete = $hasAlerti18n ? $this->l('alert_delete_multiple') : 'Are you sure that you want to delete those {items_amount} items?';

$alert_multiple_delete_one = $hasAlerti18n ? $this->l('alert_delete_multiple_one') : 'Are you sure that you want to delete this 1 item?';
            ...
            <div class="table-container">
                ...
                <div class="header-tools">
                    ...
                    <div class="floatR">
                        ...
                        <a class="btn btn-primary search-button t5 floatR" href="javascript:;">
                        ...
                        <div class="btn-group floatR t20 l10 settings-button-container">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="javascript:void(0)" class="clear-filtering dropdown-item">
                                    <i class="el el-eraser"></i> Limpiar filtros
                                </a>
                            </div>
                        </div>
